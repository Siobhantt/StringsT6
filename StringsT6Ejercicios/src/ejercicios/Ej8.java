...
*/
	...
	public static void main(String[] args) {
		...
		String prefijo = "Javalín, javalón"; //guardo en una variable el prefijo
		String sufijo = "javalén, len, len";//guardo en una variable el sufijo
		...
		if(empieza || termina) { //en caso de que la frase contenga el prefijo O el sufijo
			...
			if(empieza ==true) {
			fraseTraducida = frase.replaceAll(prefijo, "").trim();
			
			}else {
			fraseTraducida = frase.replaceAll(sufijo, "").trim();
			}
		}
